...
It replicates the basic functionality of a file manager but in a **command-line interface (CLI)** — offering an efficient and lightweight way to manage files using simple commands.  
...
## 🗓️ Day-wise Implementation

| Day | Task | Description |
|-----|------|--------------|
| **Day 1** | 📂 List Files | Designed the structure and implemented directory listing |
| **Day 2** | 🧭 Navigation | Added directory traversal commands such as `cd` and `ls` |
| **Day 3** | ⚙️ File Manipulation | Enabled file operations like `cp`, `mv`, `rm`, `mkdir`, and `touch` |
...
- 🖥️ Command-line user interaction and automation  
